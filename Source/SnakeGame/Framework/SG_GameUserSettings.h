...
public:
    ...
    SnakeGame::Dimensions GridSize() const { return CurrentGridSize.Value; }
...
private:
    ...
    {
        FString Name;
        SnakeGame::Dimensions Value;
    };
    const TMap<EGridSize, FGridData> GridSizes  //
        {
            {EGridSize::Size_30x10, {"30x10", SnakeGame::Dimensions{30, 10}}},  //
            {EGridSize::Size_50x15, {"50x15", SnakeGame::Dimensions{50, 15}}},  //
            {EGridSize::Size_80x20, {"80x20", SnakeGame::Dimensions{80, 20}}},  //
        };
